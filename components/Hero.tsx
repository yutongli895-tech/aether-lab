...
import { ChevronRight, Play, Zap as LucideZap } from 'lucide-react';
    ...
    <section id="hero" className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        ...
        <div className="mt-20 relative max-w-6xl mx-auto">
          <div className="relative glass rounded-2xl p-2 shadow-2xl overflow-hidden">
            <img 
              src="https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&q=80&w=1200" 
              alt="Dashboard Preview" 
              className="rounded-xl border border-white/10 opacity-80 w-full h-auto"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-[#030303] via-transparent to-transparent opacity-60 rounded-xl" />
          </div>
          
          <div className="absolute -bottom-10 -left-6 hidden lg:block glass p-4 rounded-xl border border-indigo-500/20 shadow-lg animate-bounce">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-indigo-500/20 rounded-lg flex items-center justify-center text-indigo-400">
                <ZapIcon className="w-6 h-6" />
              </div>
              <div className="text-left">
                <p className="text-[10px] text-zinc-400 uppercase font-bold tracking-widest">Efficiency</p>
                <p className="text-sm font-bold">99.9% Sync</p>
              </div>
            </div>
          </div>
        </div>
